...
<div class="page" id="page-help">
  ...
  <div class="info-page" style="padding-top:40px">
    ...
    <p>
      <code>← →</code> Navigate images<br>
      <code>D</code> Delete selected box<br>
      <code>P</code> Set to Person class<br>
      <code>A</code> AI Analyse (save)<br>
      <code>M</code> Copy/Move dialog<br>
      <code>E</code> Toggle panel<br>
      <code>G</code> Gallery view<br>
      <code>J</code> Jump to image #<br>
      <code>Ctrl+Z</code> Undo<br>
      <code>Ctrl+Scroll</code> Zoom<br>
      <code>Scroll</code> Navigate images<br>
      <code>Space</code> Play/pause (video)<br>
      <code>Right-click</code> Context menu
    </p>

    <h2>Community</h2>

    <p>
      Need help or want to chat? Join the Alice Discord community.<br><br>
      <a href="https://discord.gg/SnsDbNuhmW" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:8px;background:#5865F2;color:#fff;padding:8px 16px;border-radius:8px;text-decoration:none;font-weight:600;font-size:var(--fs-base)">
